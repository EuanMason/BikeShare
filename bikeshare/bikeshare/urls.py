...
urlpatterns = [
    ...
    path('register-a-administrative-role-963852741/', register_views.to_register_view_other),
    path('create-a-administrative-role-963852741/', register_views.register_other_view),
